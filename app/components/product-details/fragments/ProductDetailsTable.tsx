...
export const ProductDetailsTable: React.FC<ProductDetailsProps> = ({ details }) => (
  <Table headline="Produktdetails" entries={mapProductDetailsToFormattedDetails(details)} />
);
