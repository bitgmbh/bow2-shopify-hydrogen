...
> & {
  ...
  descriptionHtml?: StorefrontAPI.Maybe<
...
export type VariantsByIdQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
}>;

export type VariantsByIdQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql \n  query VariantsById($ids: [ID!]!) {\n    nodes(ids: $ids) {\n      ... on ProductVariant {\n        id\n        title\n        sku\n        price {\n          amount\n          currencyCode\n        }\n        image {\n          url\n          altText\n        }\n        product {\n          id\n          title\n          handle\n        }\n      }\n    }\n  }\n': {
    return: VariantsByIdQuery;
    variables: VariantsByIdQueryVariables;
  };
}
